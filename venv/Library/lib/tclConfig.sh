...
# installed.
TCL_PREFIX='H:/health_agent/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='H:/health_agent/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='H:/health_agent/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IH:/health_agent/venv\Library\include'
...
TCL_PACKAGE_PATH='H:/health_agent/venv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LH:/health_agent/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='H:/health_agent/venv\Library\lib\tclstub86.lib'
